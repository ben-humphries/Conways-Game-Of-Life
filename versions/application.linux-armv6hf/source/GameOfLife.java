...
public void randomGrid(){
    ...
    for(int x = 0; x< cells.length; x++){
      for(int y = 0; y < cells.length; y++){
        cells[x][y] = (random(0,1) > 0.5f) ? true : false;
      }
    }
...
public void saveFileAs(String dir){
...
//Draw UI Elements.
public void drawUI(boolean openFileSelected, boolean saveFileAsSelected){
...
public void paintCells(boolean alive){
...
public void walkGrid(int x0, int y0, int x1, int y1, boolean alive){
